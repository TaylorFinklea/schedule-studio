...
Schedule Studio is a public MIT-licensed SvelteKit app with local SQLite persistence, fictional first-run seed data, a Tokyo Night-inspired dark planner UI, and saved schedule versions for active/default and sandbox planning.
